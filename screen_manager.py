...
class MainFrame(wx.Frame):
    ...
    def switch_panel(self, name, remote_ip=None):
        ...
        if name == "login":
            ...
            self.current_panel = LiveChatPanel(self, self.switch_panel, self.send_to_server, self.HOST, remote_ip)
